...
class PerroModel {
    ...
    public function getAllPerros($orderBy = 'nombre', $order = 'ASC') {
        $allowedColumns = ['nombre', 'nacimiento', 'padre', 'sexo', 'madre'];
        $order = strtoupper($order) == 'DESC' ? 'DESC' : 'ASC';
        
        if (!in_array($orderBy, $allowedColumns)) {
            $orderBy = 'nombre'; // Orden predeterminado si el campo no es permitido
        }
